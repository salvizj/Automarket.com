            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="/user/profile"
                            class="nav-link px-2 text-dark active text-decoration-underline">Profile</a></li>
                </ul>
                @if (Auth::check())
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <p class="card-text">
                            ...
                            <input type="text" name="first_name" class="form-control" id="first_name_input"
                                value="{{ auth()->user()->first_name }}" style="display:none;">
                        </p>
                        <h5 class="card-title">Last Name:</h5>
                        <p class="card-text">
                            <span id="last_name">{{ auth()->user()->last_name }}</span>
                            <input type="text" name="last_name" class="form-control" id="last_name_input"
                                value="{{ auth()->user()->last_name }}" style="display:none;">
                        </p>
                        <h5 class="card-title">Number:</h5>
                        <p class="card-text">
                            <span id="number">{{ auth()->user()->number }}</span>
                            <input type="text" name="number" class="form-control" id="number_input"
                                value="{{ auth()->user()->number }}" style="display:none;">
                        </p>
