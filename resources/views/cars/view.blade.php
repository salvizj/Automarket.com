            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        @endif
                        <div class="form-control" id="edit-picture">
                    ...
                    <div class="col-md-6">
                        ...
                        <ul>
                            ...
                            <li><strong>Distance:</strong>
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control distance-input" id="edit-distance"name="distance" value="{{ $car->distance }}">
                                </div>
                            </li>
                            <li><strong>Price:</strong>
                                <span class="price-text">{{ $car->price }} &euro;</span>
                                <div class="col-md-2">
                                    <input type="text" class="form-control price-input" id="edit-price"name="price" value="{{ $car->price }}">
                                </div>
                            </li>
                        </ul>
                    </div>
